...
image1 = imread('images/lambda=20/brightfield/100um_10x.tif');
image2 = imread('images/lambda=20/brightfield/100um_10x_2.tif');
image_total = [image1 image2];
%construct full fluorescence image
image_fluor1 = (imread('images/lambda=20/fluor/100um_g_f_10x.jpg'));
image_fluor2 = (imread('images/lambda=20/fluor/100um_g_f_10x_2.jpg'));
...
intensity_tracker_100um_lambda20 = zeros(num_circles,1);
for n=1:num_circles
    center = centers(n,:);
    radius = radii(n);
    ...
    intensity_tracker_100um_lambda20(n) = norm_intensity;
end