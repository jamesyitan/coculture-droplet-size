...
image1 = imread('images/brightfield/20190611_100um.BMP');
image2 = imread('images/brightfield/20190611_100um_1.BMP');
image_total = [image1 image2];
%construct full fluorescence image
image_fluor1 = (imread('images/fluor/C2-20190611_100um_f.jpg'));
image_fluor2 = (imread('images/fluor/C2-20190611_100um_1_f.jpg'));
