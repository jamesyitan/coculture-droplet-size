function [final_densities,timeseries] = calc_dynamics_concentration(n,K,mu_max,half_sat,alpha,beta,color,num_time_steps)
%calc_dynamics
%   Author: James Tan    Last Modified: December 20, 2021
%
%   Outputs: 
...
%       target species at each timestep. 
    ...
    % This simulation takes into account the 
