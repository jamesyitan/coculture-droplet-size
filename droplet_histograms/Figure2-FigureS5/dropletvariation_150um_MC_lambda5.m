...
image1 = imread('images/lambda=5/brightfield/150um_10x.tif')*3;
image2 = imread('images/lambda=5/brightfield/150um_10x_2.tif')*3;
image3 = imread('images/lambda=5/brightfield/150um_10x_3.tif')*3;
image4 = imread('images/lambda=5/brightfield/150um_10x_4.tif')*3;
image_total = [image1 image2 image3 image4];
%construct full fluorescence image
image_fluor1 = (imread('images/lambda=5/fluor/150um_g_f_10x.jpg'));
image_fluor2 = (imread('images/lambda=5/fluor/150um_g_f_10x_2.jpg'));
image_fluor3 = (imread('images/lambda=5/fluor/150um_g_f_10x_3.jpg'));
image_fluor4 = (imread('images/lambda=5/fluor/150um_g_f_10x_4.jpg'));
...
intensity_tracker_150um_lambda5 = zeros(num_circles,1);
for n=1:num_circles
    center = centers(n,:);
    radius = radii(n);
    ...
    intensity_tracker_150um_lambda5(n) = norm_intensity;
end