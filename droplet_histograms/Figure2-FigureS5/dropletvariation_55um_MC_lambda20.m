...
image = imread('images/lambda=20/brightfield/55um_10x.tif')*3;
%construct full fluorescence image
image_fluor = (imread('images/lambda=20/fluor/55um_g_f_10x.jpg'));
...
intensity_tracker_55um_lambda20 = zeros(num_circles,1);
for n=1:num_circles
    center = centers(n,:);
    radius = radii(n);
    ...
    intensity_tracker_55um_lambda20(n) = norm_intensity;
end